...
<body>
    <nav class="navbar navbar-expand-lg navbar-info bg-info">
        <a class="navbar-brand" href="{{ route('home')}}">
            <img style="margin:0px 20px;width:50px;height:50px;" src="{{ asset('images/qalam icon.png')}}">
        </a>
    ...
    <main>
        ...
        <footer style="position:fixed;bottom:0;width:100%;padding:10px;" class="bg-info text-center text-lg-start">
          ...
          <script language="JavaScript" type="text/javascript" src="{{ asset('js/jquery-3.6.4.min.js') }}"></script>
