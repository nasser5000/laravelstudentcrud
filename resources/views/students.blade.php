...
@endsection
@section('serachform')
<form method="POST" action="{{route('studentserach',$data['studentname']=>'searchstudent')}}" class="d-flex" role="search">
    @csrf
    <input style="width:300px;font-size:18px;" class="form-control me-2" type="search" placeholder="Search" aria-label="Search" id="searchstudent">
